        ...
        >
          ...
          {(() => {
            ...
            const data = [
              ...
              {
                label: "Хэвийн үеийн тооцооны чадал",
                unit: "кВт",
              },
              {
                label: "Хэвийн үеийн тооцооны гүйдэл",
                unit: "А",
              },
              {
              ...
              {
                label:
                  "Аль нэг шугам тасарсан үеийн нэг шугамаар дамжих тооцооны чадал",
                unit: "кВт",
              },
              {
                label:
                  "Аль нэг шугам тасарсан үеийн нэг шугамаар дамжих тооцооны гүйдэл",
                unit: "А",
              },
              {
                label: "Аль нэг шугам тасарсан үеийн шугамын бүрэн чадал, кВА",
                unit: "кВА",
              },
              {
