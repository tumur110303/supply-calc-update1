  ...
  return (
    <ScrollView style={css.container}>
      ...
      >
        ...
        {(() => {
          const data = [
            ...
            {
              label: "Дулааны релений салгах гүйдэл",
              unit: "A",
            },
            {
              label: "Кабель",
      ...
      <Textfield
        ...
        onChangeText={(value) =>
          valueChanger(value, "loadMotor", threePhaseCheck ? [1, 150] : [1, 15])
        }
        error={{
          text: threePhaseCheck
            ? "Та 1-150 хүртэлх тоо оруулна уу"
      ...
      />
      <Textfield
        label="Хөдөлгүүрийн тэжээх шугамын эхэн дэх хүчдэлийн бодит хазайлт, (%)"
        placeholder="-4.5%-аас +10%-ын хооронд утга оруулна уу"
        icon="percent"
        keyboardType="numeric"
        value={value.acceptVoltageDrop ? value.acceptVoltageDrop + "" : ""}
        onChangeText={(value) =>
          valueChangerVoltage(value, "acceptVoltageDrop", [-4.5, 10])
        }
        error={{
          text: "Та -4.5%-аас +10% хүртэлх утга оруулна уу",
      ...
      <FormSwitch
        ...
        trueText="3-н фазын хөдөлгүүр"
        falseText="1 фазын хөдөлгүүр"
        value={threePhaseCheck}
        label="Хөдөлгүүрийн фазын тоог оруулна уу"
      />
      {threePhaseCheck && (
        <FormSwitch
          icon={endConnectStar ? "axis" : "delta"}
          onValueChange={setEndConnectStar}
          trueText="Од холбогдсон"
          falseText="Гурвалжин холбогдсон"
          value={endConnectStar}
          label="Хөдөлгүүрийн ороомгийн төгсгөлийн үзүүрүүд :"
        />
      )}
      <FormPicker
        label="Кабелийн маяг"
