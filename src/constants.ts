export const main: string = "#1b98f5";

export const light: string = "#ffffff";
export const gray: string = "#62697a";
export const dark: string = "#202430";
export const darker: string = "#0e1322";
export const blue: string = "#12B0E8";
export const green: string = "#02B290";
export const lightGreen: string = "#DFFFD8";
export const red:string = '#EF476F';
export const orange:string = '#F6BA6F';
export const purple:string = '#E8A0BF'
